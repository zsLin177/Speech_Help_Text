...
from utils.asr_data import ASRData
...
if __name__ == '__main__':
    ...
    data_arg.add_argument('--dataset_name', type=str, default="Aishell-ASR")
    ...
    data_arg.add_argument('--checkpoint', type=str, help='trained model')
    ...
    learning_arg.add_argument('--wp_steps', type=int, default=25000)
    ...
    trainer = Trainer(model, data, args, detailed_lr=False, onlyasr=True)
    trainer.output_ctc('test', args.generated_param_directory+'asr_pred.txt', configs)